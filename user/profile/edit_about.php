							...
							<div class="col-lg-8 col-lg-offset-1">
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="form-group <?php echo (hasError('number')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="text" class="form-control" placeholder="Contact Number" name="number" value="<?= escape($detail->contact_num) ?>">
									...
									<div class="form-group <?php echo (hasError('show')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<label class="checkbox-inline">
												<input type="checkbox" id="inlineCheckbox1" value="1" name="show" <?=(($detail->show_contact ==1 ) ? "checked": "") ?>> check this to show the number
											</label>
									...
									<div class="form-group <?php echo (hasError('address')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="text" class="form-control" placeholder="Address" name="address" value="<?= escape($detail->address) ?>" id="autocomplete">
									...
									<div class="form-group <?php echo (hasError('facebook')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="url" class="form-control" placeholder="Facebook Url" name="facebook" value="<?= escape($detail->facebook) ?>">
									...
									<div class="form-group <?php echo (hasError('linkedin')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="url" class="form-control" placeholder="Linkedin Url" name="linkedin" value="<?= escape($detail->linkedin) ?>">
									...
									<div class="form-group <?php echo (hasError('twitter')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="url" class="form-control" placeholder="Twitter Url" name="twitter" value="<?= escape($detail->twitter) ?>">
									...
									<div class="form-group <?php echo (hasError('instagram')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="url" class="form-control" placeholder="Instagram Url" name="instagram" value="<?= escape($detail->instagram) ?>">
									...
									<div class="form-group <?php echo (hasError('google')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="url" class="form-control" placeholder="Google Url" name="google" value="<?= escape($detail->google) ?>">
									...
									<div class="form-group <?php echo (hasError('about')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<textarea class="form-control ckeditor" name="about" rows="6" ><?= escape($detail->detail) ?></textarea>
