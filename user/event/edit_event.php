							...
							<div class="col-lg-8 col-lg-offset-1">
								<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									...
									<div class="form-group <?php echo (hasError('date')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="text" class="form-control input-medium default-date-picker" placeholder="Event Date" name="date" value="<?php echo $data->date ?>">
									...
									<div class="form-group <?php echo (hasError('venue')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="text" class="form-control" placeholder="Event Venue" name="venue" value="<?php echo $data->venue ?>">
									...
									<div class="form-group <?php echo (hasError('organized')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<input type="text" class="form-control" placeholder="Event organized by" name="organized" value="<?php echo $data->organize_by ?>">
									...
									<div class="form-group <?php echo (hasError('about')?'has-error':''); ?>">
										...
										<div class="col-lg-8">
											<textarea class="form-control ckeditor" name="about" rows="6" ><?php echo $data->description ?></textarea>
