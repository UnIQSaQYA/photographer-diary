...
$photographers = $photographerObj->featured();
						...
						<div class="btn-toolbar" role="toolbar" aria-label="...">
							<div class="btn-group" role="group" aria-label="...">
								...
								<?php foreach (range('A', 'Z') as $char): ?>
									<a href="<?= URL .'featured?sort='.$char ?>" class="btn btn-default"><?php echo $char . "\n"; ?></a>
								<?php endforeach ?>
							</div>
						</div>
					</div>	
						...
						<div class="card">
							<div class="front">
								...
								<div class="content-card">
									<div class="main">
										<h3 class="name"><a href="<?= URL . $photographer->slug ?>"><?= $photographer->first_name .' ' .$photographer->last_name?></a></h3>
										<p class="profession"><?= $photographer->subcategory_name ?></p>
