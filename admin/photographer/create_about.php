				...
				<div class="panel-body">
					<form role="form" method="post" enctype="multipart/form-data">
						...
						<div class="form-group col-lg-6 <?php echo (hasError('address')?'has-error':''); ?>" style="padding: 0px;">
							...
							<div class="col-lg-12">
								<input type="text" class="form-control" name="address" placeholder="Address" id="autocomplete">
						...
						<div class="form-group col-lg-6 <?php echo (hasError('google')?'has-error':''); ?>" style="padding: 0px;">
							...
							<div class="col-lg-12">
								<input type="text" class="form-control" name="google" placeholder="google">
						...
						<div class="form-group col-lg-12 <?php echo (hasError('about')?'has-error':''); ?>" style="padding: 0px;">
							<label for="linkedin" class="col-lg-12 control-label">About</label>
							<div class="col-lg-12">
